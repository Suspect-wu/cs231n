...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        affine_hid_out, cache_affine_hid = affine_relu_forward(conv_out, W2, b2)
        scores, cache_affine_out = affine_forward(affine_hid_out, W3, b3)
        pass
        ...
        dX3, grads['W3'], grads['b3'] = affine_backward(dout, cache_affine_out)
        dX2, grads['W2'], grads['b2'] = affine_relu_backward(dX3, cache_affine_hid)
